import { useListVeiculos, useListOficinas } from "@workspace/api-client-react";
...
export default function Dashboard() {
  const { data: oficinas, isLoading: oficinasLoading } = useListOficinas();
        ...
        <Card className="shadow-sm border-border/50 hover-elevate transition-all duration-300">
          ...
          <CardContent>
            {oficinasLoading ? (
              ...
              <div className="text-3xl font-bold">{oficinas?.length ?? 0}</div>
            )}
          </CardContent>
        </Card>
        ...
        <Card className="shadow-sm border-border/50 hover-elevate transition-all duration-300">
          ...
          <CardContent>
            {veiculosLoading ? (
              ...
              <div className="text-3xl font-bold">{veiculos?.length ?? 0}</div>
            )}
          </CardContent>
        </Card>
      </div>
